...
/** 
 * DAO for table "PRODUCT_INFO_CASE".
*/
public class ProductInfoCaseDao extends AbstractDao<ProductInfoCase, Long> {

    public static final String TABLENAME = "PRODUCT_INFO_CASE";

    /**
     * Properties of entity ProductInfoCase.<br/>
    ...
    public ProductInfoCaseDao(DaoConfig config) {
        super(config);
    }
    
    public ProductInfoCaseDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PRODUCT_INFO_CASE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"PRODUCT_INFO_CASE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ProductInfoCase entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ProductInfoCase entity) {
        stmt.clearBindings();
    ...
    @Override
    public ProductInfoCase readEntity(Cursor cursor, int offset) {
        ProductInfoCase entity = new ProductInfoCase( //
    ...
    @Override
    public void readEntity(Cursor cursor, ProductInfoCase entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(ProductInfoCase entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(ProductInfoCase entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(ProductInfoCase entity) {
