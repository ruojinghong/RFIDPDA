 ...
 */
public class GroundingAllocationBiz implements IGroundingBiz{
    @Override
    ...
    public void checkInCode(Context context, String arrivalId, String inCode, long time , String tag, ICommonResult callback) {
        Map<String, String> params = new HashMap<>();
        params.put("allocation_id",arrivalId);
        params.put("incode",inCode);
        PdaHttpUtil.post(context, GlobalCfg.rootUrl + "api/pda/task/storage/check_allocation_incode", params, tag, callback, false);
    }
    ...
    public void upAllocationData(Context context, String allocationId, String incodeList, String taskId, String tag, ICommonResult callback) {
        Map<String, String> params = new HashMap<>();
        params.put("allocation_code",allocationId);
        PdaHttpUtil.post(context, GlobalCfg.rootUrl + "api/pda/task/allocation/instorage_allocation", params, tag, callback, false);
    }
    ...
    public void getAllocationData(Context context, String code, int type, String tag, ICommonResult callback) {
        ...
        PdaHttpUtil.post(context, GlobalCfg.rootUrl + "api/pda/task/allocation/get_instorage", params, tag, callback, false);
    }
    ...
    public void upSignData(Context context, String shelf, String incodes, String rfids, String allocationCode, String tag, ICommonResult callback) {
        ...
        PdaHttpUtil.post(context, GlobalCfg.rootUrl + "api/pda/task/allocation/in_storage", params, tag, callback, false);
    }
