...
public class CircleProgressView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setColor(Color.rgb(0x45, 0x45, 0x45));
        ...
        //mPaint.setColor(Color.rgb(0x21, 0x36, 0x47));
        mPaint.setColor(Color.rgb(0x6b, 0xad, 0x02));
        mPaint.setStrokeWidth(mCircleLineStrokeWidth + 12);
