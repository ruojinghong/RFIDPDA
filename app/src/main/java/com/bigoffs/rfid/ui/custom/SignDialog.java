...
public class SignDialog extends Dialog {
    ...
    private List<AllocationError> rfidList;
    ...
    private SignDialog(@NonNull Context context) {
        super(context);
    }
    ...
    public SignDialog(@NonNull Context context, int themeResId, ScanPresenter presenter, List<AllocationError> s) {
    ...
    public void show(List<AllocationError> errList, int position, boolean next) {
